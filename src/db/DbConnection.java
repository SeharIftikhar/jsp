...
public class DbConnection {
    ...
    public void insertRecord(String fname, String lname, String gender, String country){
        try {
            String sqlQuery = "INSERT INTO jspdata(fname, lname, gender country) VALUES(?, ?, ?,?)";
    ...
    public ResultSet getRecord(String fname, String lname, String gender, String country){
        try {
            String sqlQuery = "SELECT * FROM jspdata";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1,fname);
            preparedStatement.setString(2, lname);
            preparedStatement.setString(3, gender);
